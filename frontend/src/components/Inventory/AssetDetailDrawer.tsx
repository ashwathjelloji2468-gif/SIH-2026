              ...
              <div className="rounded-2xl border border-cyan-500/30 bg-[#0F172A] p-5 sm:col-span-2 space-y-3 shadow-lg">
                ...
                <div className="grid grid-cols-3 gap-3 text-center">
                  <div className="p-3 rounded-xl bg-cyan-950/40 border border-cyan-800/50">
                    ...
                    <div className="text-xl font-bold font-mono text-cyan-200 mt-1">{asset.effective_x_years != null ? `${asset.effective_x_years}y` : 'Not assessed'}</div>
                  ...
                  <div className="p-3 rounded-xl bg-amber-950/40 border border-amber-800/50">
                    ...
                    <div className="text-xl font-bold font-mono text-amber-200 mt-1">{asset.effective_y_years != null ? `${asset.effective_y_years}y` : 'Not assessed'}</div>
